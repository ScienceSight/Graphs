...
@Component({
  selector: 'graph-review',
  templateUrl: './graph-review.component.html',
  styleUrls: ['./graph-review.component.css']
})
export class GraphReviewComponent implements OnInit, OnDestroy {
  graphForm: FormGroup;
